# A playroom for exploration

This layout is a practical suggestion; a large room does not need to be filled with equipment.

- **Books and comfort:** accessible board books and a clear, comfortable place to sit together.
- **Movement:** open floor space, a soft ball, and stable age-rated equipment if already available. Keep running paths away from furniture corners.
- **Build and discover:** large blocks, nesting containers, and simple toddler toys with securely enclosed parts.
- **Art:** washable surface and large, age-appropriate drawing tools. Store materials away between supervised sessions.
- **Music and pretend:** a soft doll, sturdy pretend cup, and a purpose-made toddler instrument without detachable small parts.

Offer a manageable selection and rotate based on interest, not a fixed numerical rule. Anchor furniture, secure cords and windows, gate hazards, and inspect toys for loose pieces. Keep batteries, magnets, balloons, plastic bags, and small objects inaccessible. Follow equipment age limits. [AAP home and toddler safety](https://www.healthychildren.org/English/ages-stages/toddler/Pages/Safety-for-Your-Child-1-to-2-Years.aspx)
