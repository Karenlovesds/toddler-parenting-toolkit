# 16 months — Explore cause and effect
...
![Month 16 illustration: explore cause and effect](../assets/month-16.svg)
...
**Official real examples:** CDC publishes real milestone photos and videos only at its checkpoint ages; nearest are the [15-month library](https://www.cdc.gov/act-early/milestones-in-action/15-months.html) and the [18-month library](https://www.cdc.gov/act-early/milestones-in-action/18-months.html). There is no separate CDC media for this month.

## Parenting focus

Repeat an enjoyable action and notice what changes. Let them choose when to stop.

## Choose one invitation at a time

- **STEAM:** Pour between two large cups in a supervised water basin. Describe “more” or “empty” without quizzing.
- **Art:** Try a sturdy brush with water on a washable surface. Keep the water setup under the same close supervision as other water play.
- **Reading and language:** Pair a book picture with a safe familiar object, such as a cup.
- **Sports and movement:** Walk or crawl to a nearby basket together, using whichever movement they already manage.
- **Music:** Alternate a short song with a quiet pause and watch for their response.
- **Confidence and connection:** Offer two acceptable choices: “Book or ball?” Accept their gesture as an answer.
...
Compare sleep observations across caregivers; record persistent difficulties for the clinician rather than changing naps from a preset calendar.

**Reflection:** Do they ask to repeat an action through looks, gestures, movement, or sounds?
